...
#     __tablename__ = 'user'
#     id = sq.Column(sq.Integer, primary_key=True)
#     name = sq.Column(sq.String(length=20), unique=False)
#     surname = sq.Column(sq.String(length=20), unique=False)
#     vk_id = sq.Column(sq.Integer, unique=True)
#     gender = sq.Column(sq.String(length=20), sq.ForeignKey('gender.id'))
